...
* <https://docs.spring.io/spring-boot/docs/2.7.7/maven-plugin/reference/htmlsingle/#using-parent-pom>
* <https://docs.spring.io/spring-boot/docs/2.7.7/maven-plugin/reference/htmlsingle/#using-import>
...
SpringBoot内置以下[Log Groups](https://docs.spring.io/spring-boot/docs/2.7.7/reference/htmlsingle/#features.logging.log-groups)
