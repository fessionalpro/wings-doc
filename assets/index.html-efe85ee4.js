...
mysql:8.0
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_9-3-app-deployment" tabindex="-1"><a class="header-anchor" href="#_9-3-app-deployment" aria-hidden="true">#</a> 9.3.App Deployment</h2>`,13),u=s("code",null,"ln -s",-1),m={href:"http://wings-starter.sh",target:"_blank",rel:"noopener noreferrer"},k=s("code",null,"good-devops",-1),b=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> <span class="token variable">$PROJECT_DIR</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_9-6-security-option" tabindex="-1"><a class="header-anchor" href="#_9-6-security-option" aria-hidden="true">#</a> 9.6.Security Option</h2><p>The default password in wings project is <code>\${random.uuid}</code> or environment variable. In actual production, some need to set to fixed password. Password strength, must be more than 32-bit random characters, alphanumeric case mix is best.</p>`,13),h=s("li",null,[s("code",null,"DING_TALK_TOKEN"),n(" - System variable, boot-admin login password")],-1),g=s("li",null,[s("code",null,"wings.silencer.encrypt.leap-code"),n(" - Pseudo-random number, can keep it")],-1),_=s("li",null,[s("code",null,"wings.silencer.encrypt.crc8-long"),n(" - Add crc checksum to number, can keep it")],-1),f=s("code",null,"wings.silencer.encrypt.aes-key.*",-1),w=s("code",null,"wings.slardar.hazelcast.cluster-name",-1),y=s("p",null,[n("In example project, use "),s("code",null,"DING_TALK_TOKEN"),n(" as default password")],-1),x=s("code",null,"spring.boot.admin.client.username",-1),C=s("code",null,"spring.boot.admin.client.password",-1),D=s("code",null,"spring.boot.admin.client.instance.metadata.user.name",-1),N=s("code",null,"spring.boot.admin.client.instance.metadata.user.password",-1),P=s("p",null,"The default values for all of the above config items should be based on the corresponding manual or source code to avoid the security implications of outdated documentation.",-1),j=s("h2",{id:"_9-7-start-up-args",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#_9-7-start-up-args","aria-hidden":"true"},"#"),n(" 9.7.Start-up Args")],-1),A=s("code",null,"add-opens",-1),E=s("code",null,"illegal-access",-1),S={href:"http://starter.sh",target:"_blank",rel:"noopener noreferrer"},T=t(`<ul><li><code>/pom.xml</code> - <code>wings.java-opens</code> with reason</li><li><code>/observe/scripts/wings-starter.sh</code> - <code>JDK9_ARG</code></li></ul><p>The details of <code>add-opens</code> are as follows, handle line breaks when using</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>--add-modules java.se
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3);function R(O,$){const o=l("ExternalLinkIcon"),e=l("Badge");return p(),d("div",null,[v,s("p",null,[n("Softlink("),u,n(") "),s("a",m,[n("wings-starter.sh"),a(o)]),n(" to some execution location, using "),k,n(" as an example.")]),b,s("ul",null,[h,g,_,s("li",null,[f,n(" - "),a(e,{type:"tip",vertical:"top"},{default:i(()=>[n("SHOULD")]),_:1}),n(" change")]),s("li",null,[w,n(" - hazelcast clust name, "),a(e,{type:"info",vertical:"top"},{default:i(()=>[n("MUST")]),_:1}),n(" change")])]),y,s("ul",null,[s("li",null,[x,n(" - boot.admin server-side username, "),a(e,{type:"tip",vertical:"top"},{default:i(()=>[n("SHOULD")]),_:1}),n(" change")]),s("li",null,[C,n(" - boot.admin server-side password, "),a(e,{type:"info",vertical:"top"},{default:i(()=>[n("MUST")]),_:1}),n(" change")]),s("li",null,[D,n(" - client-side username, "),a(e,{type:"tip",vertical:"top"},{default:i(()=>[n("SHOULD")]),_:1}),n(" change")]),s("li",null,[N,n(" - client-side password, "),a(e,{type:"info",vertical:"top"},{default:i(()=>[n("MUST")]),_:1}),n(" change")])]),P,j,s("p",null,[n("In springboot3(after java17), "),A,n(" must be set correctly to avoid "),E,n(". Wings set correctly in pom.xml and "),s("a",S,[n("starter.sh"),a(o)]),n(", with the following files and variable names.")]),T])}const U=c(r,[["render",R],["__file","index.html.vue"]]);export{U as default};
