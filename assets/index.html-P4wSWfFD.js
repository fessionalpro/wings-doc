import{_ as t}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as o,o as c,c as p,b as n,e as s,d as e,w as i,f as l}from"./app-GuRyqIDd.js";const d={},r=l(`<h1 id="_9-实战演示" tabindex="-1"><a class="header-anchor" href="#_9-实战演示" aria-hidden="true">#</a> 9.实战演示</h1><p>运行<code>wings-init-project.sh</code>生成一个样板工程。</p><h2 id="_9-1-前置条件" tabindex="-1"><a class="header-anchor" href="#_9-1-前置条件" aria-hidden="true">#</a> 9.1.前置条件</h2><p>基本知识及动手能力</p><ul><li>了解 <code>maven</code>，缺什么，补什么。</li><li>了解 <code>spring*</code>，<code>看官方文档</code> x 3！</li><li>了解 <code>mysql*</code>数据库，mysql</li></ul><p>目录约定</p><ul><li><code>WINGS_DIR</code> - wings_boot的工程根目录</li><li><code>WINGS_BIN</code> - <code>WINGS_DIR</code>/observe/scripts</li><li><code>PROJECT_DIR</code> - 示例工程的目录，例如<code>good-demo</code></li><li><code>PROJECT_PCD</code> - 示例工程的CodeName，例如<code>good</code></li></ul><h2 id="_9-2-自建环境" tabindex="-1"><a class="header-anchor" href="#_9-2-自建环境" aria-hidden="true">#</a> 9.2.自建环境</h2><p>新建工程及打包的示例脚本</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># asdf shell java temurin-17.0.9+9</span>
