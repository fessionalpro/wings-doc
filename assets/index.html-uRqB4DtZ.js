import{_ as t}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as p,o,c,b as n,e as s,d as e,w as i,f as l}from"./app-mN42Vc4a.js";const d={},r=l(`<h1 id="_9-实战演示" tabindex="-1"><a class="header-anchor" href="#_9-实战演示"><span>9.实战演示</span></a></h1><p>运行<code>wings-init-project.sh</code>生成一个样板工程。</p><h2 id="_9-1-前置条件" tabindex="-1"><a class="header-anchor" href="#_9-1-前置条件"><span>9.1.前置条件</span></a></h2><p>基本知识及动手能力</p><ul><li>了解 <code>maven</code>，缺什么，补什么。</li><li>了解 <code>spring*</code>，<code>看官方文档</code> x 3！</li><li>了解 <code>mysql*</code>数据库，mysql</li></ul><p>目录约定</p><ul><li><code>WINGS_DIR</code> - wings_boot的工程根目录</li><li><code>WINGS_BIN</code> - <code>WINGS_DIR</code>/observe/scripts</li><li><code>PROJECT_DIR</code> - 示例工程的目录，例如<code>good-demo</code></li><li><code>PROJECT_PCD</code> - 示例工程的CodeName，例如<code>good</code></li></ul><h2 id="_9-2-自建环境" tabindex="-1"><a class="header-anchor" href="#_9-2-自建环境"><span>9.2.自建环境</span></a></h2><p>新建工程及打包的示例脚本</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># asdf shell java temurin-17.0.9+9</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>数据库，默认采用H2演示，可自建Docker演示Mysql，示例脚本如下。</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 设置变量</span>
...
mysql:8.0
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_9-3-程序部署" tabindex="-1"><a class="header-anchor" href="#_9-3-程序部署"><span>9.3.程序部署</span></a></h2><p>软连接(<code>ln -s</code>)wings-starter.sh到某个执行位置，以good-devops为例。</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> <span class="token variable">$PROJECT_DIR</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在env中，port,jar,log容易理解，按项目需要配置即可。 BOOT_CNF是用来替换默认配置的运行时配置，结构如下。</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>├── application.properties // 程序级设置
├── wings-conf // 自动配置，按需覆盖内部文件
│     └── spring-datasource.properties
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_9-4-反向代理" tabindex="-1"><a class="header-anchor" href="#_9-4-反向代理"><span>9.4.反向代理</span></a></h2><p>通常的配置参考，包括强制https，保护误操作.git，前后端分离。</p><div class="language-nginx line-numbers-mode" data-ext="nginx" data-title="nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">upstream</span> good_admin</span> <span class="token punctuation">{</span>
...
<span class="token directive"><span class="token keyword">server</span></span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_9-5-压力测试" tabindex="-1"><a class="header-anchor" href="#_9-5-压力测试"><span>9.5.压力测试</span></a></h2><p>压力测试，必须<code>ulimit -n</code>在10k以上，同一内网以忽略带宽限制。</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> <span class="token variable">$PROJECT_DIR</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用jmeter 模拟10K*50请求</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token builtin class-name">ulimit</span> <span class="token parameter variable">-n</span> <span class="token number">45535</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_9-6-安全选项" tabindex="-1"><a class="header-anchor" href="#_9-6-安全选项"><span>9.6.安全选项</span></a></h2><p>wings工程中的默认密码均为<code>\${random.uuid}</code>或环境变量。实际生产中，有些需要设置为固定密码。 密码强度，必须在32位以上的随机字符，字母数字大小写混合最好。</p>`,27),v=n("li",null,[n("code",null,"DING_TALK_TOKEN"),s(" - 系统变量，boot-admin登录密码")],-1),u=n("li",null,[n("code",null,"wings.silencer.encrypt.leap-code"),s(" - 伪随机数，可不更换")],-1),m=n("li",null,[n("code",null,"wings.silencer.encrypt.crc8-long"),s(" - 数字增加crc校验，可不更换")],-1),k=n("code",null,"wings.silencer.encrypt.aes-key.*",-1),b=n("code",null,"wings.slardar.hazelcast.cluster-name",-1),_=n("p",null,[s("example中的配置，默认以"),n("code",null,"DING_TALK_TOKEN"),s("为密码")],-1),g=n("code",null,"spring.boot.admin.client.username",-1),h=n("code",null,"spring.boot.admin.client.password",-1),f=n("code",null,"spring.boot.admin.client.instance.metadata.user.name",-1),x=n("code",null,"spring.boot.admin.client.instance.metadata.user.password",-1),y=l(`<p>上述全部配置项的默认值，以对应的配置项的手册或源代码为准，避免文档过期影响安全性。</p><h2 id="_9-7-启动参数" tabindex="-1"><a class="header-anchor" href="#_9-7-启动参数"><span>9.7.启动参数</span></a></h2><p>在springboot3，即java17后，必须正确设置<code>add-opens</code>，以避免<code>illegal-access</code>。 Wings在pom.xml和starter.sh中已进行了正确的设置，其文件及变量名字如下，</p><ul><li><code>/pom.xml</code> - <code>javaopenArgLine</code> 有原因说明</li><li><code>/observe/scripts/wings-starter.sh</code> - <code>JDK9_ARG</code></li><li><code>&lt;arg&gt;</code> - 参数必须使用<code>=</code>指定。在shell解析中支持空格分隔</li></ul><p><code>add-opens</code>的具体内容如下，使用时按需处理换行</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>--add-modules=java.se
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6);function w(C,N){const a=p("Badge");return o(),c("div",null,[r,n("ul",null,[v,u,m,n("li",null,[k,s(" - "),e(a,{type:"tip",vertical:"top"},{default:i(()=>[s("建议")]),_:1}),s("更换")]),n("li",null,[b,s(" - hazelcast集群名，"),e(a,{type:"info",vertical:"top"},{default:i(()=>[s("必须")]),_:1}),s("更换")])]),_,n("ul",null,[n("li",null,[g,s(" - boot.admin server端用户，"),e(a,{type:"tip",vertical:"top"},{default:i(()=>[s("建议")]),_:1}),s("更换")]),n("li",null,[h,s(" - boot.admin server端密码，"),e(a,{type:"info",vertical:"top"},{default:i(()=>[s("必须")]),_:1}),s("更换")]),n("li",null,[f,s(" - client端用户，"),e(a,{type:"tip",vertical:"top"},{default:i(()=>[s("建议")]),_:1}),s("更换")]),n("li",null,[x,s(" - client端密码，"),e(a,{type:"info",vertical:"top"},{default:i(()=>[s("必须")]),_:1}),s("更换")])]),y])}const A=t(d,[["render",w],["__file","index.html.vue"]]);export{A as default};
