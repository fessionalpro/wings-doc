import{_ as t,W as l,X as c,Z as s,a0 as n,$ as e,a3 as i,a2 as p,F as o}from"./framework-f37db9b8.js";const d={},r=p(`<h1 id="_9-实战演示" tabindex="-1"><a class="header-anchor" href="#_9-实战演示" aria-hidden="true">#</a> 9.实战演示</h1><p>运行<code>wings-init-project.sh</code>生成一个样板工程。</p><h2 id="_9-1-前置条件" tabindex="-1"><a class="header-anchor" href="#_9-1-前置条件" aria-hidden="true">#</a> 9.1.前置条件</h2><ul><li>了解 <code>maven</code>，缺什么，补什么。</li><li>了解 <code>spring*</code>，<code>看官方文档，不要百度</code> x 3！</li><li>了解 <code>mysql*</code>数据库，mysql</li></ul><h2 id="_9-2-自建环境" tabindex="-1"><a class="header-anchor" href="#_9-2-自建环境" aria-hidden="true">#</a> 9.2.自建环境</h2><p>默认采用H2内存数据库演示，可自建Docker演示Mysql。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 设置变量</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_9-6-安全选项" tabindex="-1"><a class="header-anchor" href="#_9-6-安全选项" aria-hidden="true">#</a> 9.6.安全选项</h2><p>wings工程中的默认密码均为<code>\${random.uuid}</code>或环境变量。实际生产中，有些需要设置为固定密码。 密码强度，必须在32位以上的随机字符，字母数字大小写混合最好。</p>`,22),u=s("li",null,[s("code",null,"DING_TALK_TOKEN"),n(" - 系统变量，boot-admin登录密码")],-1),v=s("li",null,[s("code",null,"wings.silencer.encrypt.leap-code"),n(" - 伪随机数，可不更换")],-1),m=s("li",null,[s("code",null,"wings.silencer.encrypt.crc8-long"),n(" - 数字增加crc校验，可不更换")],-1),k=s("code",null,"wings.silencer.encrypt.aes-key.*",-1),b=s("code",null,"wings.slardar.hazelcast.cluster-name",-1),h=s("p",null,[n("example中的配置，默认以"),s("code",null,"DING_TALK_TOKEN"),n("为密码")],-1),_=s("code",null,"spring.boot.admin.client.username",-1),g=s("code",null,"spring.boot.admin.client.password",-1),w=s("code",null,"spring.boot.admin.client.instance.metadata.user.name",-1),x=s("code",null,"spring.boot.admin.client.instance.metadata.user.password",-1),y=s("p",null,"上述全部配置项的默认值，以对应的配置项的手册或源代码为准，避免文档过期影响安全性。",-1);function f(q,$){const a=o("Badge");return l(),c("div",null,[r,s("ul",null,[u,v,m,s("li",null,[k,n(" - "),e(a,{type:"tip",vertical:"top"},{default:i(()=>[n("建议")]),_:1}),n("更换")]),s("li",null,[b,n(" - hazelcast集群名，"),e(a,{type:"info",vertical:"top"},{default:i(()=>[n("必须")]),_:1}),n("更换")])]),h,s("ul",null,[s("li",null,[_,n(" - boot.admin server端用户，"),e(a,{type:"tip",vertical:"top"},{default:i(()=>[n("建议")]),_:1}),n("更换")]),s("li",null,[g,n(" - boot.admin server端密码，"),e(a,{type:"info",vertical:"top"},{default:i(()=>[n("必须")]),_:1}),n("更换")]),s("li",null,[w,n(" - client端用户，"),e(a,{type:"tip",vertical:"top"},{default:i(()=>[n("建议")]),_:1}),n("更换")]),s("li",null,[x,n(" - client端密码，"),e(a,{type:"info",vertical:"top"},{default:i(()=>[n("必须")]),_:1}),n("更换")])]),y])}const S=t(d,[["render",f],["__file","index.html.vue"]]);export{S as default};
