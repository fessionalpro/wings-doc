import{_ as l}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as o,o as c,c as p,b as n,e as s,d as e,w as i,f as t}from"./app-bOcR57Nd.js";const d={},r=t(`<h1 id="_9-practice-and-sample" tabindex="-1"><a class="header-anchor" href="#_9-practice-and-sample" aria-hidden="true">#</a> 9.Practice and Sample</h1><p>Execute <code>wings-init-project.sh</code> to generate a template project.</p><h2 id="_9-1-pre-requisite" tabindex="-1"><a class="header-anchor" href="#_9-1-pre-requisite" aria-hidden="true">#</a> 9.1.Pre-Requisite</h2><p>Basic knowledge and hands-on ability,</p><ul><li>Understand <code>maven</code>, what is missing, what to learn.</li><li>Understand <code>spring*</code>, <code>see official documentation</code> x 3!</li><li>Understand <code>mysql*</code> mysql database</li></ul><p>Directory conventions</p><ul><li><code>WINGS_DIR</code> - the project root of wings_boot</li><li><code>WINGS_BIN</code> - <code>WINGS_DIR</code>/observe/scripts</li><li><code>PROJECT_DIR</code> - the directory of the sample project, e.g. <code>good-demo</code></li><li><code>PROJECT_PCD</code> - CodeName of the sample project, e.g. <code>good</code></li></ul><h2 id="_9-2-diy-environment" tabindex="-1"><a class="header-anchor" href="#_9-2-diy-environment" aria-hidden="true">#</a> 9.2.DIY Environment</h2><p>Sample scripts for new project and command to package,</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># asdf shell java temurin-17.0.9+9</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6);function x(C,D){const a=o("Badge");return c(),p("div",null,[r,n("ul",null,[v,u,m,n("li",null,[b,s(" - "),e(a,{type:"tip",vertical:"top"},{default:i(()=>[s("SHOULD")]),_:1}),s(" change")]),n("li",null,[k,s(" - hazelcast clust name, "),e(a,{type:"info",vertical:"top"},{default:i(()=>[s("MUST")]),_:1}),s(" change")])]),h,n("ul",null,[n("li",null,[g,s(" - boot.admin server-side username, "),e(a,{type:"tip",vertical:"top"},{default:i(()=>[s("SHOULD")]),_:1}),s(" change")]),n("li",null,[_,s(" - boot.admin server-side password, "),e(a,{type:"info",vertical:"top"},{default:i(()=>[s("MUST")]),_:1}),s(" change")]),n("li",null,[f,s(" - client-side username, "),e(a,{type:"tip",vertical:"top"},{default:i(()=>[s("SHOULD")]),_:1}),s(" change")]),n("li",null,[y,s(" - client-side password, "),e(a,{type:"info",vertical:"top"},{default:i(()=>[s("MUST")]),_:1}),s(" change")])]),w])}const j=l(d,[["render",x],["__file","index.html.vue"]]);export{j as default};
