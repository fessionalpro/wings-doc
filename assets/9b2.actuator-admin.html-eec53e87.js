import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r,o,c as l,b as n,e as s,d as a,f as t}from"./app-76302e33.js";const c={},p=t('<h1 id="_9b2-actuator-and-bootadmin" tabindex="-1"><a class="header-anchor" href="#_9b2-actuator-and-bootadmin" aria-hidden="true">#</a> 9B2.Actuator and BootAdmin</h1><p>wings体系下，默认启动了基本的监控</p><ul><li>Wings 启停和日志通知</li><li>Hazelcast Management Center</li><li>Spring Boot Admin</li><li>Prometheus Grafana</li><li>Sentry 日志监控</li></ul><h2 id="_9b2-1-启停和日志" tabindex="-1"><a class="header-anchor" href="#_9b2-1-启停和日志" aria-hidden="true">#</a> 9B2.1.启停和日志</h2><p>wings app 默认会通过钉钉报告启动，停止信息，以及日志文件中WARN的信息。 而wings-starter.sh也可以通过cron监控pid是否存在和log是否增长。</p><h2 id="_9b2-2-hazelcast监控" tabindex="-1"><a class="header-anchor" href="#_9b2-2-hazelcast监控" aria-hidden="true">#</a> 9B2.2.hazelcast监控</h2><p>Hazelcast版本随spring boot同步更新，主要用作caching, Session，其次是Event和Lock，Messaging等。</p>',7),d={href:"https://docs.hazelcast.com/imdg/4.2/",target:"_blank",rel:"noopener noreferrer"},m=n("p",null,"在wings的基本应用中，一般只有3个节点(admin/devops/front)构成的集群，使用log和ManagementCenter监控。 因3节点集群的强壮性刚好够用，以CP Subsystem Unsafe Mode运行，仅能提供弱一致性保证，不如CP的强一致性。",-1),u=n("ul",null,[n("li",null,"CP Subsystem Management APIs are not available."),n("li",null,"split-brain protection is not supported.")],-1),v={href:"https://docs.hazelcast.com/management-center/5.0/",target:"_blank",rel:"noopener noreferrer"},b=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">wget</span> https://repository.hazelcast.com/download/management-center/hazelcast-management-center-5.0.4.zip
...
grafana/grafana-oss
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后导入 预定义的面板。</p>`,3),q={href:"https://grafana.com/grafana/dashboards/4701",target:"_blank",rel:"noopener noreferrer"},w=n("h2",{id:"_9b2-5-sentry-日志监控",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_9b2-5-sentry-日志监控","aria-hidden":"true"},"#"),s(" 9B2.5.Sentry 日志监控")],-1),B={href:"https://sentry.io",target:"_blank",rel:"noopener noreferrer"},E={href:"https://github.com/getsentry/self-hosted",target:"_blank",rel:"noopener noreferrer"},A=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#https://develop.sentry.dev/self-hosted/</span>
