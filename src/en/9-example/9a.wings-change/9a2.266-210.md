...
Starting with 210, all artifactId are merged into `pro.professional.wings` group.
...
It is recommended to manage the java8 and java11 environment with [sdkman](https://sdkman.io/)
