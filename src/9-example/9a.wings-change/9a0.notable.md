...
[ElderTitan]: https://github.com/trydofor/pro.fessional.wings/tree/feature/ElderTitan
...
## Ongoing [ElderTitan] 307.300

* 💥 WingsTableCudHandler interface change
* 💥 `wings.faceless.jooq.cud.insert` to `.create`
* ✨ `wings.faceless.jooq.cud.table`, `-` ignore table, `empty` ingore fields
* 🔥 ComboWarlockAuthnService without Cacheable
* 🐛 expose SpringSessionBackedSessionRegistry
